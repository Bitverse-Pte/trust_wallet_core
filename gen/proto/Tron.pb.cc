...
constexpr TransferTRC20Contract::TransferTRC20Contract(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
struct TransferTRC20ContractDefaultTypeInternal {
  constexpr TransferTRC20ContractDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~TransferTRC20ContractDefaultTypeInternal() {}
  union {
    TransferTRC20Contract _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT TransferTRC20ContractDefaultTypeInternal _TransferTRC20Contract_default_instance_;
...
constexpr FreezeBalanceV2Contract::FreezeBalanceV2Contract(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : owner_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , resource_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , frozen_balance_(int64_t{0}){}
struct FreezeBalanceV2ContractDefaultTypeInternal {
  constexpr FreezeBalanceV2ContractDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT FreezeBalanceV2ContractDefaultTypeInternal _FreezeBalanceV2Contract_default_instance_;
constexpr UnfreezeBalanceV2Contract::UnfreezeBalanceV2Contract(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : owner_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , resource_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , unfreeze_balance_(int64_t{0}){}
struct UnfreezeBalanceV2ContractDefaultTypeInternal {
  constexpr UnfreezeBalanceV2ContractDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT UnfreezeBalanceV2ContractDefaultTypeInternal _UnfreezeBalanceV2Contract_default_instance_;
constexpr WithdrawExpireUnfreezeContract::WithdrawExpireUnfreezeContract(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : owner_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct WithdrawExpireUnfreezeContractDefaultTypeInternal {
  constexpr WithdrawExpireUnfreezeContractDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT WithdrawExpireUnfreezeContractDefaultTypeInternal _WithdrawExpireUnfreezeContract_default_instance_;
constexpr DelegateResourceContract::DelegateResourceContract(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : owner_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , resource_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , receiver_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
struct DelegateResourceContractDefaultTypeInternal {
  constexpr DelegateResourceContractDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT DelegateResourceContractDefaultTypeInternal _DelegateResourceContract_default_instance_;
constexpr UnDelegateResourceContract::UnDelegateResourceContract(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : owner_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , resource_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , receiver_address_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
struct UnDelegateResourceContractDefaultTypeInternal {
  constexpr UnDelegateResourceContractDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT UnDelegateResourceContractDefaultTypeInternal _UnDelegateResourceContract_default_instance_;
...
constexpr BlockHeader::BlockHeader(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : tx_trie_root_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , parent_hash_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Tron_2eproto[20];
...
const uint32_t TableStruct_Tron_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::TW::Tron::Proto::SigningOutput, error_),
  PROTOBUF_FIELD_OFFSET(::TW::Tron::Proto::SigningOutput, error_message_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::TW::Tron::Proto::TransferContract)},
  { 9, -1, -1, sizeof(::TW::Tron::Proto::TransferAssetContract)},
  { 19, -1, -1, sizeof(::TW::Tron::Proto::TransferTRC20Contract)},
  { 29, -1, -1, sizeof(::TW::Tron::Proto::FreezeBalanceContract)},
  { 40, -1, -1, sizeof(::TW::Tron::Proto::FreezeBalanceV2Contract)},
  { 49, -1, -1, sizeof(::TW::Tron::Proto::UnfreezeBalanceV2Contract)},
  { 58, -1, -1, sizeof(::TW::Tron::Proto::WithdrawExpireUnfreezeContract)},
  { 65, -1, -1, sizeof(::TW::Tron::Proto::DelegateResourceContract)},
  { 76, -1, -1, sizeof(::TW::Tron::Proto::UnDelegateResourceContract)},
  { 86, -1, -1, sizeof(::TW::Tron::Proto::UnfreezeBalanceContract)},
  { 95, -1, -1, sizeof(::TW::Tron::Proto::UnfreezeAssetContract)},
  { 102, -1, -1, sizeof(::TW::Tron::Proto::VoteAssetContract)},
  { 112, -1, -1, sizeof(::TW::Tron::Proto::VoteWitnessContract_Vote)},
  { 120, -1, -1, sizeof(::TW::Tron::Proto::VoteWitnessContract)},
  { 129, -1, -1, sizeof(::TW::Tron::Proto::WithdrawBalanceContract)},
  { 136, -1, -1, sizeof(::TW::Tron::Proto::TriggerSmartContract)},
  { 148, -1, -1, sizeof(::TW::Tron::Proto::BlockHeader)},
  { 160, -1, -1, sizeof(::TW::Tron::Proto::Transaction)},
  { 186, -1, -1, sizeof(::TW::Tron::Proto::SigningInput)},
  { 195, -1, -1, sizeof(::TW::Tron::Proto::SigningOutput)},
};
...
const char descriptor_table_protodef_Tron_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nTron.proto\022\rTW.Tron.Proto\032\014Common.prot"
  ...
  "ss\030\003 \001(\t\022\016\n\006amount\030\004 \001(\003\"l\n\025TransferTRC2"
  "0Contract\022\030\n\020contract_address\030\001 \001(\t\022\025\n\ro"
  "wner_address\030\002 \001(\t\022\022\n\nto_address\030\003 \001(\t\022\016"
  "\n\006amount\030\004 \001(\014\"\213\001\n\025FreezeBalanceContract"
  "\022\025\n\rowner_address\030\001 \001(\t\022\026\n\016frozen_balanc"
  "e\030\002 \001(\003\022\027\n\017frozen_duration\030\003 \001(\003\022\020\n\010reso"
  "urce\030\n \001(\t\022\030\n\020receiver_address\030\017 \001(\t\"Z\n\027"
  "FreezeBalanceV2Contract\022\025\n\rowner_address"
  "\030\001 \001(\t\022\026\n\016frozen_balance\030\002 \001(\003\022\020\n\010resour"
  "ce\030\003 \001(\t\"^\n\031UnfreezeBalanceV2Contract\022\025\n"
  "\rowner_address\030\001 \001(\t\022\030\n\020unfreeze_balance"
  "\030\002 \001(\003\022\020\n\010resource\030\003 \001(\t\"7\n\036WithdrawExpi"
  "reUnfreezeContract\022\025\n\rowner_address\030\001 \001("
  ...
  "r_address\030\017 \001(\t\".\n\025UnfreezeAssetContract"
  "\022\025\n\rowner_address\030\001 \001(\t\"`\n\021VoteAssetCont"
  "ract\022\025\n\rowner_address\030\001 \001(\t\022\024\n\014vote_addr"
  "ess\030\002 \003(\t\022\017\n\007support\030\003 \001(\010\022\r\n\005count\030\005 \001("
  "\005\"\247\001\n\023VoteWitnessContract\022\025\n\rowner_addre"
  "ss\030\001 \001(\t\0226\n\005votes\030\002 \003(\0132\'.TW.Tron.Proto."
  "VoteWitnessContract.Vote\022\017\n\007support\030\003 \001("
  "\010\0320\n\004Vote\022\024\n\014vote_address\030\001 \001(\t\022\022\n\nvote_"
  "count\030\002 \001(\003\"0\n\027WithdrawBalanceContract\022\025"
  "\n\rowner_address\030\001 \001(\t\"\225\001\n\024TriggerSmartCo"
  "ntract\022\025\n\rowner_address\030\001 \001(\t\022\030\n\020contrac"
  "t_address\030\002 \001(\t\022\022\n\ncall_value\030\003 \001(\003\022\014\n\004d"
  "ata\030\004 \001(\014\022\030\n\020call_token_value\030\005 \001(\003\022\020\n\010t"
  "oken_id\030\006 \001(\003\"\205\001\n\013BlockHeader\022\021\n\ttimesta"
  "mp\030\001 \001(\003\022\024\n\014tx_trie_root\030\002 \001(\014\022\023\n\013parent"
  "_hash\030\003 \001(\014\022\016\n\006number\030\007 \001(\003\022\027\n\017witness_a"
  "ddress\030\t \001(\014\022\017\n\007version\030\n \001(\005\"\375\010\n\013Transa"
  "ction\022\021\n\ttimestamp\030\001 \001(\003\022\022\n\nexpiration\030\002"
  " \001(\003\0220\n\014block_header\030\003 \001(\0132\032.TW.Tron.Pro"
  "to.BlockHeader\022\021\n\tfee_limit\030\004 \001(\003\0223\n\010tra"
  "nsfer\030\n \001(\0132\037.TW.Tron.Proto.TransferCont"
  "ractH\000\022>\n\016transfer_asset\030\013 \001(\0132$.TW.Tron"
  ".Proto.TransferAssetContractH\000\022>\n\016freeze"
  "_balance\030\014 \001(\0132$.TW.Tron.Proto.FreezeBal"
  "anceContractH\000\022B\n\020unfreeze_balance\030\r \001(\013"
  "2&.TW.Tron.Proto.UnfreezeBalanceContract"
  "H\000\022>\n\016unfreeze_asset\030\016 \001(\0132$.TW.Tron.Pro"
  "to.UnfreezeAssetContractH\000\022B\n\020withdraw_b"
  "alance\030\017 \001(\0132&.TW.Tron.Proto.WithdrawBal"
  "anceContractH\000\0226\n\nvote_asset\030\020 \001(\0132 .TW."
  "Tron.Proto.VoteAssetContractH\000\022:\n\014vote_w"
  "itness\030\021 \001(\0132\".TW.Tron.Proto.VoteWitness"
  "ContractH\000\022E\n\026trigger_smart_contract\030\022 \001"
  "(\0132#.TW.Tron.Proto.TriggerSmartContractH"
  "\000\022G\n\027transfer_trc20_contract\030\023 \001(\0132$.TW."
  "Tron.Proto.TransferTRC20ContractH\000\022C\n\021fr"
  "eeze_balance_v2\030\024 \001(\0132&.TW.Tron.Proto.Fr"
  "eezeBalanceV2ContractH\000\022G\n\023unfreeze_bala"
  "nce_v2\030\025 \001(\0132(.TW.Tron.Proto.UnfreezeBal"
  "anceV2ContractH\000\022Q\n\030withdraw_expire_unfr"
  "eeze\030\027 \001(\0132-.TW.Tron.Proto.WithdrawExpir"
  "eUnfreezeContractH\000\022D\n\021delegate_resource"
  "\030\030 \001(\0132\'.TW.Tron.Proto.DelegateResourceC"
  "ontractH\000\022H\n\023undelegate_resource\030\031 \001(\0132)"
  ".TW.Tron.Proto.UnDelegateResourceContrac"
  "tH\000B\020\n\016contract_oneof\"b\n\014SigningInput\022/\n"
  "\013transaction\030\001 \001(\0132\032.TW.Tron.Proto.Trans"
  ...
  "ef_block_hash\030\004 \001(\014\022\014\n\004json\030\005 \001(\t\022,\n\005err"
  "or\030\006 \001(\0162\035.TW.Common.Proto.SigningError\022"
  "\025\n\rerror_message\030\007 \001(\tB\027\n\025wallet.core.jn"
  "i.protob\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Tron_2eproto = {
  false, false, 3175, descriptor_table_protodef_Tron_2eproto, "Tron.proto", 
  &descriptor_table_Tron_2eproto_once, descriptor_table_Tron_2eproto_deps, 1, 20,
  schemas, file_default_instances, TableStruct_Tron_2eproto::offsets,
  file_level_metadata_Tron_2eproto, file_level_enum_descriptors_Tron_2eproto, file_level_service_descriptors_Tron_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_Tron_2eproto_getter() {
  return &descriptor_table_Tron_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_Tron_2eproto(&descriptor_table_Tron_2eproto);
namespace TW {
namespace Tron {
namespace Proto {
...
uint8_t* TransferContract::_InternalSerialize(
...
::PROTOBUF_NAMESPACE_ID::Metadata TransferContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[0]);
}
...
uint8_t* TransferAssetContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
::PROTOBUF_NAMESPACE_ID::Metadata TransferAssetContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[1]);
}
...
inline void TransferTRC20Contract::SharedCtor() {
contract_address_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  contract_address_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void TransferTRC20Contract::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
uint8_t* TransferTRC20Contract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TransferTRC20Contract::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    TransferTRC20Contract::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*TransferTRC20Contract::GetClassData() const { return &_class_data_; }

void TransferTRC20Contract::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TransferTRC20Contract *>(to)->MergeFrom(
      static_cast<const TransferTRC20Contract &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata TransferTRC20Contract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[2]);
}
...
uint8_t* FreezeBalanceContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
// @@protoc_insertion_point(message_byte_size_start:TW.Tron.Proto.FreezeBalanceContract)
  ...
  // int64 frozen_balance = 2;
  if (this->_internal_frozen_balance() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_frozen_balance());
  }

  // int64 frozen_duration = 3;
  if (this->_internal_frozen_duration() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_frozen_duration());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata FreezeBalanceContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[3]);
}
...
uint8_t* FreezeBalanceV2Contract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData FreezeBalanceV2Contract::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    FreezeBalanceV2Contract::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*FreezeBalanceV2Contract::GetClassData() const { return &_class_data_; }

void FreezeBalanceV2Contract::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<FreezeBalanceV2Contract *>(to)->MergeFrom(
      static_cast<const FreezeBalanceV2Contract &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FreezeBalanceV2Contract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[4]);
}
...
uint8_t* UnfreezeBalanceV2Contract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  // int64 unfreeze_balance = 2;
  if (this->_internal_unfreeze_balance() != 0) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(message_byte_size_start:TW.Tron.Proto.UnfreezeBalanceV2Contract)
  ...
  // int64 unfreeze_balance = 2;
  if (this->_internal_unfreeze_balance() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_unfreeze_balance());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_cached_size_);
}

const ::PROTOBUF_NAMESPACE_ID::Message::ClassData UnfreezeBalanceV2Contract::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    UnfreezeBalanceV2Contract::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*UnfreezeBalanceV2Contract::GetClassData() const { return &_class_data_; }

void UnfreezeBalanceV2Contract::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<UnfreezeBalanceV2Contract *>(to)->MergeFrom(
      static_cast<const UnfreezeBalanceV2Contract &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:TW.Tron.Proto.UnfreezeBalanceV2Contract)
  ...
  if (from._internal_unfreeze_balance() != 0) {
...
::PROTOBUF_NAMESPACE_ID::Metadata UnfreezeBalanceV2Contract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[5]);
}
...
uint8_t* WithdrawExpireUnfreezeContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData WithdrawExpireUnfreezeContract::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    WithdrawExpireUnfreezeContract::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*WithdrawExpireUnfreezeContract::GetClassData() const { return &_class_data_; }

void WithdrawExpireUnfreezeContract::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<WithdrawExpireUnfreezeContract *>(to)->MergeFrom(
      static_cast<const WithdrawExpireUnfreezeContract &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata WithdrawExpireUnfreezeContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[6]);
}
...
uint8_t* DelegateResourceContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData DelegateResourceContract::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    DelegateResourceContract::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*DelegateResourceContract::GetClassData() const { return &_class_data_; }

void DelegateResourceContract::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<DelegateResourceContract *>(to)->MergeFrom(
      static_cast<const DelegateResourceContract &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata DelegateResourceContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[7]);
}
...
uint8_t* UnDelegateResourceContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData UnDelegateResourceContract::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    UnDelegateResourceContract::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*UnDelegateResourceContract::GetClassData() const { return &_class_data_; }

void UnDelegateResourceContract::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<UnDelegateResourceContract *>(to)->MergeFrom(
      static_cast<const UnDelegateResourceContract &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata UnDelegateResourceContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[8]);
}
...
uint8_t* UnfreezeBalanceContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
::PROTOBUF_NAMESPACE_ID::Metadata UnfreezeBalanceContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[9]);
}
...
uint8_t* UnfreezeAssetContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
::PROTOBUF_NAMESPACE_ID::Metadata UnfreezeAssetContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[10]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VoteAssetContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[11]);
}
...
uint8_t* VoteWitnessContract_Vote::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
// @@protoc_insertion_point(message_byte_size_start:TW.Tron.Proto.VoteWitnessContract.Vote)
  ...
  // int64 vote_count = 2;
  if (this->_internal_vote_count() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_vote_count());
  }
...
void VoteWitnessContract_Vote::InternalSwap(VoteWitnessContract_Vote* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &vote_address_, lhs_arena,
      &other->vote_address_, rhs_arena
  );
...
::PROTOBUF_NAMESPACE_ID::Metadata VoteWitnessContract_Vote::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[12]);
}
...
uint8_t* VoteWitnessContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
::PROTOBUF_NAMESPACE_ID::Metadata VoteWitnessContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[13]);
}
...
uint8_t* WithdrawBalanceContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
::PROTOBUF_NAMESPACE_ID::Metadata WithdrawBalanceContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[14]);
}
...
uint8_t* TriggerSmartContract::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
// @@protoc_insertion_point(message_byte_size_start:TW.Tron.Proto.TriggerSmartContract)
  ...
  // int64 call_value = 3;
  if (this->_internal_call_value() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_call_value());
  }

  // int64 call_token_value = 5;
  if (this->_internal_call_token_value() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_call_token_value());
  }

  // int64 token_id = 6;
  if (this->_internal_token_id() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_token_id());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata TriggerSmartContract::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[15]);
}
...
uint8_t* BlockHeader::_InternalSerialize(
  ...
  // bytes tx_trie_root = 2;
  if (!this->_internal_tx_trie_root().empty()) {
    target = stream->WriteBytesMaybeAliased(
...
void BlockHeader::InternalSwap(BlockHeader* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &tx_trie_root_, lhs_arena,
      &other->tx_trie_root_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &parent_hash_, lhs_arena,
      &other->parent_hash_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &witness_address_, lhs_arena,
      &other->witness_address_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
::PROTOBUF_NAMESPACE_ID::Metadata BlockHeader::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[16]);
}
...
void Transaction::set_allocated_transfer(::TW::Tron::Proto::TransferContract* transfer) {
  ...
  if (transfer) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::TransferContract>::GetOwningArena(transfer);
...
void Transaction::set_allocated_transfer_asset(::TW::Tron::Proto::TransferAssetContract* transfer_asset) {
  ...
  if (transfer_asset) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::TransferAssetContract>::GetOwningArena(transfer_asset);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_freeze_balance(::TW::Tron::Proto::FreezeBalanceContract* freeze_balance) {
  ...
  if (freeze_balance) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::FreezeBalanceContract>::GetOwningArena(freeze_balance);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_unfreeze_balance(::TW::Tron::Proto::UnfreezeBalanceContract* unfreeze_balance) {
  ...
  if (unfreeze_balance) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::UnfreezeBalanceContract>::GetOwningArena(unfreeze_balance);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_unfreeze_asset(::TW::Tron::Proto::UnfreezeAssetContract* unfreeze_asset) {
  ...
  if (unfreeze_asset) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::UnfreezeAssetContract>::GetOwningArena(unfreeze_asset);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_withdraw_balance(::TW::Tron::Proto::WithdrawBalanceContract* withdraw_balance) {
  ...
  if (withdraw_balance) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::WithdrawBalanceContract>::GetOwningArena(withdraw_balance);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_vote_asset(::TW::Tron::Proto::VoteAssetContract* vote_asset) {
  ...
  if (vote_asset) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::VoteAssetContract>::GetOwningArena(vote_asset);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_vote_witness(::TW::Tron::Proto::VoteWitnessContract* vote_witness) {
  ...
  if (vote_witness) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::VoteWitnessContract>::GetOwningArena(vote_witness);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_trigger_smart_contract(::TW::Tron::Proto::TriggerSmartContract* trigger_smart_contract) {
  ...
  if (trigger_smart_contract) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::TriggerSmartContract>::GetOwningArena(trigger_smart_contract);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_transfer_trc20_contract(::TW::Tron::Proto::TransferTRC20Contract* transfer_trc20_contract) {
  ...
  if (transfer_trc20_contract) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::TransferTRC20Contract>::GetOwningArena(transfer_trc20_contract);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_freeze_balance_v2(::TW::Tron::Proto::FreezeBalanceV2Contract* freeze_balance_v2) {
  ...
  if (freeze_balance_v2) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::FreezeBalanceV2Contract>::GetOwningArena(freeze_balance_v2);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_unfreeze_balance_v2(::TW::Tron::Proto::UnfreezeBalanceV2Contract* unfreeze_balance_v2) {
  ...
  if (unfreeze_balance_v2) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::UnfreezeBalanceV2Contract>::GetOwningArena(unfreeze_balance_v2);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_withdraw_expire_unfreeze(::TW::Tron::Proto::WithdrawExpireUnfreezeContract* withdraw_expire_unfreeze) {
  ...
  if (withdraw_expire_unfreeze) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::WithdrawExpireUnfreezeContract>::GetOwningArena(withdraw_expire_unfreeze);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_delegate_resource(::TW::Tron::Proto::DelegateResourceContract* delegate_resource) {
  ...
  if (delegate_resource) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::DelegateResourceContract>::GetOwningArena(delegate_resource);
    if (message_arena != submessage_arena) {
...
void Transaction::set_allocated_undelegate_resource(::TW::Tron::Proto::UnDelegateResourceContract* undelegate_resource) {
  ...
  if (undelegate_resource) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TW::Tron::Proto::UnDelegateResourceContract>::GetOwningArena(undelegate_resource);
    if (message_arena != submessage_arena) {
...
uint8_t* Transaction::_InternalSerialize(
  ...
  if (_internal_has_freeze_balance_v2()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        20, _Internal::freeze_balance_v2(this), target, stream);
  }
  ...
  if (_internal_has_unfreeze_balance_v2()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        21, _Internal::unfreeze_balance_v2(this), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:TW.Tron.Proto.Transaction)
  ...
  // int64 fee_limit = 4;
  if (this->_internal_fee_limit() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_fee_limit());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata Transaction::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[17]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SigningInput::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[18]);
}
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "TW.Tron.Proto.SigningOutput.error_message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SigningOutput::_InternalSerialize(
  ...
  if (!this->_internal_error_message().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "TW.Tron.Proto.SigningOutput.error_message");
    target = stream->WriteStringMaybeAliased(
...
void SigningOutput::InternalSwap(SigningOutput* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &ref_block_bytes_, lhs_arena,
      &other->ref_block_bytes_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &ref_block_hash_, lhs_arena,
      &other->ref_block_hash_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &json_, lhs_arena,
...
::PROTOBUF_NAMESPACE_ID::Metadata SigningOutput::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Tron_2eproto_getter, &descriptor_table_Tron_2eproto_once,
      file_level_metadata_Tron_2eproto[19]);
}
