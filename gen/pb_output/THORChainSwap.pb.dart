...
class SwapOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SwapOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.THORChainSwap.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$1.SigningInput>(4, _omitFieldNames ? '' : 'bitcoin', subBuilder: $1.SigningInput.create)
    ..aOM<$2.SigningInput>(5, _omitFieldNames ? '' : 'ethereum', subBuilder: $2.SigningInput.create)
    ..aOM<$5.SigningInput>(6, _omitFieldNames ? '' : 'binance', subBuilder: $5.SigningInput.create)
  ...
  @$pb.TagNumber(6)
  $5.SigningInput get binance => $_getN(5);
  @$pb.TagNumber(6)
  set binance($5.SigningInput v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasBinance() => $_has(5);
  @$pb.TagNumber(6)
  void clearBinance() => clearField(6);
  @$pb.TagNumber(6)
  $5.SigningInput ensureBinance() => $_ensure(5);

  @$pb.TagNumber(7)
  $3.SigningInput get cosmos => $_getN(6);
  @$pb.TagNumber(7)
  set cosmos($3.SigningInput v) { setField(7, v); }
  @$pb.TagNumber(7)
