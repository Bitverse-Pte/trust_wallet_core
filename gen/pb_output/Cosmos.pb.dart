...
class Message_ExecuteContract extends $pb.GeneratedMessage {
  factory Message_ExecuteContract({
    $core.String? sender,
  ...
  Message_ExecuteContract._() : super();
  factory Message_ExecuteContract.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Message_ExecuteContract.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message.ExecuteContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Cosmos.Proto'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'sender')
    ..aOS(2, _omitFieldNames ? '' : 'contract')
    ..aOS(3, _omitFieldNames ? '' : 'executeMsg')
    ..pc<Amount>(4, _omitFieldNames ? '' : 'coins', $pb.PbFieldType.PM, subBuilder: Amount.create)
    ..aOS(5, _omitFieldNames ? '' : 'typePrefix')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Message_ExecuteContract clone() => Message_ExecuteContract()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Message_ExecuteContract copyWith(void Function(Message_ExecuteContract) updates) => super.copyWith((message) => updates(message as Message_ExecuteContract)) as Message_ExecuteContract;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Message_ExecuteContract create() => Message_ExecuteContract._();
  Message_ExecuteContract createEmptyInstance() => create();
  static $pb.PbList<Message_ExecuteContract> createRepeated() => $pb.PbList<Message_ExecuteContract>();
  @$core.pragma('dart2js:noInline')
  static Message_ExecuteContract getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Message_ExecuteContract>(create);
  static Message_ExecuteContract? _defaultInstance;
...
class Message extends $pb.GeneratedMessage {
  factory Message({
    ...
    Message_ExecuteContract? executeContractMessage,
    ...
    if (executeContractMessage != null) {
      $result.executeContractMessage = executeContractMessage;
    }
  ...
  static const $core.Map<$core.int, Message_MessageOneof> _Message_MessageOneofByTag = {
    ...
    11 : Message_MessageOneof.executeContractMessage,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Cosmos.Proto'), createEmptyInstance: create)
    ...
    ..aOM<Message_ExecuteContract>(11, _omitFieldNames ? '' : 'executeContractMessage', subBuilder: Message_ExecuteContract.create)
  ...
  @$pb.TagNumber(11)
  Message_ExecuteContract get executeContractMessage => $_getN(10);
  @$pb.TagNumber(11)
  set executeContractMessage(Message_ExecuteContract v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasExecuteContractMessage() => $_has(10);
  @$pb.TagNumber(11)
  void clearExecuteContractMessage() => clearField(11);
  @$pb.TagNumber(11)
  Message_ExecuteContract ensureExecuteContractMessage() => $_ensure(10);

  @$pb.TagNumber(12)
  Message_WasmTerraExecuteContractGeneric get wasmTerraExecuteContractGeneric => $_getN(11);
  @$pb.TagNumber(12)
  set wasmTerraExecuteContractGeneric(Message_WasmTerraExecuteContractGeneric v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasWasmTerraExecuteContractGeneric() => $_has(11);
  @$pb.TagNumber(12)
  void clearWasmTerraExecuteContractGeneric() => clearField(12);
  @$pb.TagNumber(12)
  Message_WasmTerraExecuteContractGeneric ensureWasmTerraExecuteContractGeneric() => $_ensure(11);

  @$pb.TagNumber(13)
  Message_WasmExecuteContractTransfer get wasmExecuteContractTransferMessage => $_getN(12);
  @$pb.TagNumber(13)
  set wasmExecuteContractTransferMessage(Message_WasmExecuteContractTransfer v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasWasmExecuteContractTransferMessage() => $_has(12);
  @$pb.TagNumber(13)
  void clearWasmExecuteContractTransferMessage() => clearField(13);
  @$pb.TagNumber(13)
  Message_WasmExecuteContractTransfer ensureWasmExecuteContractTransferMessage() => $_ensure(12);

  @$pb.TagNumber(14)
  Message_WasmExecuteContractSend get wasmExecuteContractSendMessage => $_getN(13);
  @$pb.TagNumber(14)
  set wasmExecuteContractSendMessage(Message_WasmExecuteContractSend v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasWasmExecuteContractSendMessage() => $_has(13);
  @$pb.TagNumber(14)
  void clearWasmExecuteContractSendMessage() => clearField(14);
  @$pb.TagNumber(14)
  Message_WasmExecuteContractSend ensureWasmExecuteContractSendMessage() => $_ensure(13);

  @$pb.TagNumber(15)
  Message_WasmExecuteContractGeneric get wasmExecuteContractGeneric => $_getN(14);
  @$pb.TagNumber(15)
  set wasmExecuteContractGeneric(Message_WasmExecuteContractGeneric v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasWasmExecuteContractGeneric() => $_has(14);
  @$pb.TagNumber(15)
  void clearWasmExecuteContractGeneric() => clearField(15);
  @$pb.TagNumber(15)
  Message_WasmExecuteContractGeneric ensureWasmExecuteContractGeneric() => $_ensure(14);

  @$pb.TagNumber(16)
  Message_SignDirect get signDirectMessage => $_getN(15);
  @$pb.TagNumber(16)
  set signDirectMessage(Message_SignDirect v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasSignDirectMessage() => $_has(15);
  @$pb.TagNumber(16)
  void clearSignDirectMessage() => clearField(16);
  @$pb.TagNumber(16)
  Message_SignDirect ensureSignDirectMessage() => $_ensure(15);

  @$pb.TagNumber(17)
  Message_AuthGrant get authGrant => $_getN(16);
  @$pb.TagNumber(17)
  set authGrant(Message_AuthGrant v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasAuthGrant() => $_has(16);
  @$pb.TagNumber(17)
  void clearAuthGrant() => clearField(17);
  @$pb.TagNumber(17)
  Message_AuthGrant ensureAuthGrant() => $_ensure(16);

  @$pb.TagNumber(18)
  Message_AuthRevoke get authRevoke => $_getN(17);
  @$pb.TagNumber(18)
  set authRevoke(Message_AuthRevoke v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasAuthRevoke() => $_has(17);
  @$pb.TagNumber(18)
  void clearAuthRevoke() => clearField(18);
  @$pb.TagNumber(18)
  Message_AuthRevoke ensureAuthRevoke() => $_ensure(17);

  @$pb.TagNumber(19)
  Message_SetWithdrawAddress get setWithdrawAddressMessage => $_getN(18);
  @$pb.TagNumber(19)
  set setWithdrawAddressMessage(Message_SetWithdrawAddress v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasSetWithdrawAddressMessage() => $_has(18);
  @$pb.TagNumber(19)
  void clearSetWithdrawAddressMessage() => clearField(19);
  @$pb.TagNumber(19)
  Message_SetWithdrawAddress ensureSetWithdrawAddressMessage() => $_ensure(18);

  @$pb.TagNumber(20)
  Message_MsgVote get msgVote => $_getN(19);
  @$pb.TagNumber(20)
  set msgVote(Message_MsgVote v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasMsgVote() => $_has(19);
  @$pb.TagNumber(20)
  void clearMsgVote() => clearField(20);
  @$pb.TagNumber(20)
  Message_MsgVote ensureMsgVote() => $_ensure(19);

  @$pb.TagNumber(21)
  Message_MsgStrideLiquidStakingStake get msgStrideLiquidStakingStake => $_getN(20);
  @$pb.TagNumber(21)
  set msgStrideLiquidStakingStake(Message_MsgStrideLiquidStakingStake v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasMsgStrideLiquidStakingStake() => $_has(20);
  @$pb.TagNumber(21)
  void clearMsgStrideLiquidStakingStake() => clearField(21);
  @$pb.TagNumber(21)
  Message_MsgStrideLiquidStakingStake ensureMsgStrideLiquidStakingStake() => $_ensure(20);

  @$pb.TagNumber(22)
  Message_MsgStrideLiquidStakingRedeem get msgStrideLiquidStakingRedeem => $_getN(21);
  @$pb.TagNumber(22)
  set msgStrideLiquidStakingRedeem(Message_MsgStrideLiquidStakingRedeem v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasMsgStrideLiquidStakingRedeem() => $_has(21);
  @$pb.TagNumber(22)
  void clearMsgStrideLiquidStakingRedeem() => clearField(22);
  @$pb.TagNumber(22)
  Message_MsgStrideLiquidStakingRedeem ensureMsgStrideLiquidStakingRedeem() => $_ensure(21);

  @$pb.TagNumber(23)
  Message_THORChainDeposit get thorchainDepositMessage => $_getN(22);
  @$pb.TagNumber(23)
  set thorchainDepositMessage(Message_THORChainDeposit v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasThorchainDepositMessage() => $_has(22);
  @$pb.TagNumber(23)
  void clearThorchainDepositMessage() => clearField(23);
  @$pb.TagNumber(23)
  Message_THORChainDeposit ensureThorchainDepositMessage() => $_ensure(22);
}
