...
class Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.LiquidStaking.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$2.SigningInput>(2, _omitFieldNames ? '' : 'ethereum', subBuilder: $2.SigningInput.create)
    ..aOM<$3.SigningInput>(3, _omitFieldNames ? '' : 'cosmos', subBuilder: $3.SigningInput.create)
    ..aOM<$4.SigningInput>(4, _omitFieldNames ? '' : 'aptos', subBuilder: $4.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.SigningInput get ethereum => $_getN(1);
  @$pb.TagNumber(2)
  set ethereum($2.SigningInput v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEthereum() => $_has(1);
  @$pb.TagNumber(2)
  void clearEthereum() => clearField(2);
  @$pb.TagNumber(2)
  $2.SigningInput ensureEthereum() => $_ensure(1);

  @$pb.TagNumber(3)
  $3.SigningInput get cosmos => $_getN(2);
  @$pb.TagNumber(3)
  set cosmos($3.SigningInput v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCosmos() => $_has(2);
  @$pb.TagNumber(3)
  void clearCosmos() => clearField(3);
  @$pb.TagNumber(3)
  $3.SigningInput ensureCosmos() => $_ensure(2);

  @$pb.TagNumber(4)
  $4.SigningInput get aptos => $_getN(3);
  @$pb.TagNumber(4)
  set aptos($4.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAptos() => $_has(3);
  @$pb.TagNumber(4)
  void clearAptos() => clearField(4);
  @$pb.TagNumber(4)
  $4.SigningInput ensureAptos() => $_ensure(3);
}
